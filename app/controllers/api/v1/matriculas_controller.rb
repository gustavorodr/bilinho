    ...
    class MatriculasController < ApplicationController
      ...
      def create
        ...
        if matricula.save
          ...
          render json: { status: 'ERROR', message: 'Matricula nao salva', data: matricula.erros },
      ...
      def update
        ...
        if matricula.update_attributes(matricula_params)
          ...
          render json: { status: 'ERROR', message: 'Matricula nao atualizada', data: matricula.erros },
                 status: :unprocessable_entity
        end
      end
      # Parametros aceitos
