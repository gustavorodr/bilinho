      ...
      # Listar todos os alunos
			...
			def create
				...
				if aluno.save
					...
					render json: {status: 'ERROR', message:'Aluno nao salvo', data:aluno.erros},status: :unprocessable_entity
				end
			end
			# Excluir aluno
			def destroy
			...
			def update
				...
				if aluno.update_attributes(aluno_params)
					...
					render json: {status: 'ERROR', message:'Aluno nao atualizado', data:aluno.erros},status: :unprocessable_entity
				end
			end
			# Parametros aceitos
			private
